...
VALUES ('us-east-1', string_to_array('new york,boston,washington dc,miami,charlotte,atlanta', ',')),
       ...
       ('eu-south-1', string_to_array('madrid,barcelona,sintra,rome,milan,lyon,lisbon,toulouse,paris,cologne,seville,marseille,naples,turin,valencia,palermo',',')),
       ('eu-central-1', string_to_array('berlin,hamburg,munich,frankfurt,dusseldorf,leipzig,dortmund,essen,stuttgart',',')),
       ('eu-east-1', string_to_array('krakov,zagraeb,zaragoza,lodz,athens,bratislava,prague,sofia,bucharest,vienna,warsaw,budapest',',')),
...
VALUES ('aws','us-east-1', string_to_array('us-east-1',',')),
       ...
       ('gcp','europe-west6', string_to_array('eu-east-1',',')),
       ...
       ('gcp','gcp-europe-west1', string_to_array('eu-north-1',',')),
       ('gcp','gcp-europe-west2', string_to_array('eu-west-1',',')),
       ('gcp','gcp-europe-west3', string_to_array('eu-central-1',',')),
       ('gcp','gcp-europe-west4', string_to_array('eu-south-1',',')),
       ('gcp','gcp-europe-west6', string_to_array('eu-east-1',',')),
       ('gcp','gcp-europe-west8', string_to_array('eu-east-1',',')),
       ('gcp','gcp-us-west2', string_to_array('us-west-2',',')),
       ('gcp','gcp-australia-southeast1', string_to_array('ap-southeast-2',',')),
       ('gcp','asia-southeast-1', string_to_array('ap-southeast-2',',')),
       ('gcp','asia-southeast-2', string_to_array('ap-southeast-2',',')),
       ('gcp','asia-southeast-3', string_to_array('ap-southeast-2',','))
;

-- select array_cat_agg(city_names) from city where name in ('us-west-1','us-west-2');
