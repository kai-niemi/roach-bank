...
public class ReportController {
    ...
    public Collection<AccountSummary> getAccountSummary() {
        ...
        metadataRepository.getCurrencyRegions().forEach((currency, regions) -> {
            result.add(reportingRepository.accountSummary(currency, regions));
        });
        return result;
    }
    ...
    public Collection<TransactionSummary> getTransactionSummary() {
        ...
        metadataRepository.getCurrencyRegions().forEach((currency, regions) -> {
            result.add(reportingRepository.transactionSummary(currency, regions));
        });
        return result;
    }
}
